import { ErrorState, ExecutionStackState, MinimumProgramState, StackState } from '../../state';
...
export declare const pushOperation: <Opcodes, State extends StackState<Uint8Array> & MinimumProgramState<Opcodes> & ErrorState<Errors, AuthenticationErrorCommon> & ExecutionStackState, Errors>(flags: {
    requireMinimalEncoding: boolean;
}, maximumPushSize?: PushOperationConstants) => Operation<State>;
export declare const pushOperations: <Opcodes, State extends StackState<Uint8Array> & MinimumProgramState<Opcodes> & ErrorState<Errors, AuthenticationErrorCommon> & ExecutionStackState, Errors>(flags: {
    requireMinimalEncoding: boolean;
