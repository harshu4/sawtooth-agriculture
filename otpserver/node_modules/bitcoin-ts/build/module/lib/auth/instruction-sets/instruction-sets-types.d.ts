...
export declare type AuthenticationInstructions<Opcodes = number> = AuthenticationInstruction<Opcodes>[];
 ...
 * ```
 */
export declare type ParsedAuthenticationInstructions<Opcodes = number> = (AuthenticationInstruction<Opcodes> | ParsedAuthenticationInstruction<Opcodes>)[];
export {};
