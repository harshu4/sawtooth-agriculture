 ...
 */
export declare const encodeCashAddressVersionByte: (type: CashAddressAvailableTypes, bitLength: 192 | 224 | 256 | 160 | 320 | 384 | 448 | 512) => number;
...
export declare const decodeCashAddressVersionByte: (version: number) => CashAddressVersionByteDecodingError.reservedBitSet | {
    bitLength: 192 | 224 | 256 | 160 | 320 | 384 | 448 | 512;
    type: number;
};
/**
 ...
 */
export declare const encodeCashAddressFormat: <Prefix extends string = CashAddressNetworkPrefix, Version extends number = CashAddressVersionByte>(prefix: Prefix, version: Version, hash: Uint8Array) => string;
 ...
 */
export declare const decodeCashAddressFormat: (address: string) => import("./bech32").BitRegroupingError | CashAddressDecodingError.invalidFormat | CashAddressDecodingError.malformedPayload | CashAddressDecodingError.invalidChecksum | {
    hash: Uint8Array;
    prefix: string;
    version: number;
};
 ...
 */
export declare const decodeCashAddress: (address: string) => import("./bech32").BitRegroupingError | CashAddressDecodingError | {
    hash: Uint8Array;
    prefix: string;
    type: number;
};
 ...
 */
export declare const decodeCashAddressFormatWithoutPrefix: (address: string, possiblePrefixes?: string[]) => import("./bech32").BitRegroupingError | CashAddressDecodingError.invalidFormat | CashAddressDecodingError.malformedPayload | CashAddressDecodingError.invalidChecksum | {
    hash: Uint8Array;
    prefix: string;
    version: number;
};
 ...
 */
export declare const attemptCashAddressFormatErrorCorrection: (address: string) => CashAddressDecodingError.invalidFormat | CashAddressDecodingError.malformedPayload | CashAddressCorrectionError.tooManyErrors | {
    address: string;
    corrections: number[];
};
