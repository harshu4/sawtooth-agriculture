 ...
 * aren't relevant.)
 */
export declare const applyError: <State extends ErrorState<Errors, AuthenticationErrorCommon>, Errors>(error: Errors | AuthenticationErrorCommon, state: State) => State;
