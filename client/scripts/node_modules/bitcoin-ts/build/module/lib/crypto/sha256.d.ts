 ...
 */
export declare const instantiateSha256Bytes: (webassemblyBytes: ArrayBuffer) => Promise<Sha256>;
export declare const getEmbeddedSha256Binary: () => ArrayBuffer | SharedArrayBuffer;
/**
 ...
 */
export declare const instantiateSha256: () => Promise<Sha256>;
